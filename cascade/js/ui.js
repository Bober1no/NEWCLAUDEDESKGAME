...
(function (root) {
  ...
  function renderRisk() {
    ...
    var cards = [
      ...
      { l: 'Recovery time', v: (h.recoverySm != null ? h.recoverySm : h.recovery).toFixed(0) + ' wks', d: 'weeks of degraded service caused by a standard disruption at the largest source', p: Math.min(1, (h.recoverySm || h.recovery) / 40), s: ser(function (x) { return x.health.recoverySm || x.health.recovery; }) },
